...
export default function PatientDashboard() {
  ...
  const prescriptions = [
    { medicine: "Amoxicillin", dosage: "500mg", frequency: "3 times daily" },
    { medicine: "Lisinopril", dosage: "10mg", frequency: "Once daily" },
    { medicine: "Metformin", dosage: "1000mg", frequency: "Twice daily" },
    { medicine: "Simvastatin", dosage: "20mg", frequency: "Once daily at bedtime" },
    { medicine: "Omeprazole", dosage: "20mg", frequency: "Once daily before breakfast" },
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
              ...
              if (nextAppointment) {
                return (
                  <p className="text-xs text-gray-500">
                    Next: Dr. {nextAppointment.doctorId.firstName} {nextAppointment.doctorId.lastName} on {new Date(nextAppointment.date).toLocaleDateString('en-GB')}
                  </p>
                );
              } else {
                return (
          ...
          <CardFooter className="p-2">
            ...
            >
              {showAppointments ? "Hide" : "View"} Upcoming Appointments
              ...
              {appointments
                ...
                .map((appointment, index) => (
                  <div key={index} className="flex justify-between items-center py-2 border-t">
                    <div>
                      <p className="text-sm font-medium">Dr. {appointment.doctorId.firstName} {appointment.doctorId.lastName}</p>
                      <p className="text-xs text-gray-500">
